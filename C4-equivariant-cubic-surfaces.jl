...
f = System([a_1^3+a_1*b_1^2+b_1*c_1^2+c_1*d_1^2, 3*a_1^2*a_2+a_2*b_1^2+2*a_1*b_1*b_2+b_2*c_1^2+2*b_1*c_1*c_2+c_2*d_1^2+2*c_1*d_1*d_2,
      3*a_1*a_2^2+2*a_2*b_1*b_2+a_1*b_2^2+2*b_2*c_1*c_2+b_1*c_2^2+2*c_2*d_1*d_2+c_1*d_2^2, a_2^3+a_2*b_2^2+b_2*c_2^2+c_2*d_2^2,
...
# System Definition
f = [a_1^3+a_1*b_1^2+alpha*b_1^3+b_1*c_1^2+c_1*d_1^2,
    3*a_1^2*a_2+a_2*b_1^2+2*a_1*b_1*b_2+3*alpha*b_1^2*b_2+b_2*c_1^2+2*b_1*c_1*c_2+c_2*d_1^2+2*c_1*d_1*d_2,
    3*a_1*a_2^2+2*a_2*b_1*b_2+a_1*b_2^2+3*alpha*b_1*b_2^2+2*b_2*c_1*c_2+b_1*c_2^2+2*c_2*d_1*d_2+c_1*d_2^2,
    a_2^3+a_2*b_2^2+alpha*b_2^3+b_2*c_2^2+c_2*d_2^2,
    .911589*a_1+.88565*a_2+2.523357*b_1-.646118*b_2+.30993*c_1+.36067*c_2+.0452546*d_1+.429238*d_2+.0146597,
    .896976*a_1+.138818*a_2+.707287*b_1-.0657292*b_2+.26806*c_1+.866177*c_2+.18616*d_1+.896809*d_2+.417192,
    .473248*a_1+.643963*a_2+.12494*b_1+.520899*b_2+.576117*c_1+.486441*c_2+.384317*d_1+.552473*d_2+.18095,
    .779979*a_1+.443068*a_2+.901413*b_1+2.349995*b_2+.283387*c_1+.646477*c_2+.549256*d_1+.135106*d_2+.569817
...
println("\n[Loop 1] Red Loop")
p1 = generate_perm(compiled_homotopy,[CC(0)], red1, red2, p_list) #[1, 2, 20, 17, 5, 23, 24, 4, 8, 26, 15, 14, 16, 10, 22, 3, 9, 6, 11, 13, 21, 19, 25, 7, 18, 12, 27]
string(p1[2])
...
green3 = [CC(-1,-1)]
println("\n[Loop 2] Green Loop")
p2 = generate_perm(compiled_homotopy, green1, green2, green3, p_list) #[19, 13, 5, 3, 26, 11, 7, 14, 23, 10, 16, 6, 17, 21, 2, 12, 15, 8, 9, 20, 18, 22, 1, 27, 25, 4, 24]
string(p2[2])
